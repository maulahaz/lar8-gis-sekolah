...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2022 at 08:45 AM
...
CREATE TABLE `tbl_materi` (
  ...
  `created_by` varchar(20) CHARACTER SET utf8mb4 DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_by` varchar(20) CHARACTER SET utf8mb4 DEFAULT NULL,
...
CREATE TABLE `tbl_sekolah` (
  ...
  `jenjang_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'SMPN 1 Anyer', 'SMP', '1', '2', 'Anyer', '', 'test', 'smpn-1-anyer.jpg', NULL, NULL);
...
INSERT INTO `users` (`id`, `name`, `email`, `picture`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `username`) VALUES
(1, 'Test Categ 409', 'maulahaz@gmail.com', 'avatar-driver1.png', NULL, '$2y$10$uone1iRs3qbauKFGirGa6OvKTVTjxnOrluMa84zr96KsedQwbesou', NULL, '2021-07-22 11:15:12', '2021-07-22 11:15:12', 'admin');
