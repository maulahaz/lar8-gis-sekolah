  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <div class="card mt-3">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <a href="{{ url('admin/user') }}" class="btn btn-sm btn-outline-info"><i class="fa fa-chevron-left"></i> &nbsp;Lihat Semua Data</a>
            <a href="{{ url('admin/user/'.$updateID.'/edit') }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> &nbsp;Rubah Data</a>
            <a href="{{ url('admin/user/'.$updateID.'/changepass') }}" class="btn btn-warning btn-sm"><i class="fa fa-lock"></i> &nbsp;Ganti Password</a>
            <button class="btn btn-danger btn-sm float-right" id="btn-delete-modal" data-toggle=modal data-target="#delete-modal"><i class="fa fa-trash"></i> &nbsp;Hapus Data</button>
          </div>
          <!-- /.card-body -->
        </div>
        <!-- /.card -->
    ...
    <div class="col-sm-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="frm_upload" name="frm_upload" action="{{ url('admin/user/upload-file/'.$updateID) }}" method="POST" class="form-horizontal" enctype="multipart/form-data"> 
                @csrf
...
<div class="modal fade" id="delete-picture-modal" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
      <form id="frm_delete" name="frm_delete" action="{{ url('admin/user/remove-file/'.$updateID) }}" method="POST">
      @csrf
