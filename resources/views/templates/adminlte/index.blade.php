        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
              ...
              @else
              <img src="{{ asset('/public/images/user.png') }}" class="img-circle elevation-2" alt="User Image">
              @endif
            </div>
            <div class="info">
              @if(auth()->user())
              <a href="{{url('account/profile')}}" class="d-block">{{ Auth::user()->name }}</a>
              @else
              Guess
              @endif
            </div>
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              @if($loggedinInfo->role == '88' || $loggedinInfo->role == '99')
