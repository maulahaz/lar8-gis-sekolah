  ...
  <div class="row">
    ...
    <!-- <h1>{{ $pageTitle }}</h1> -->
      ...
      <div class="card mt-3">
        ...
        <!-- /.card-header -->
        <div class="card-body">
          <a href="{{ url('my-account/'.$updateID.'/edit') }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> &nbsp;Rubah Data</a>
          <a href="{{ url('my-account/changepass') }}" class="btn btn-warning btn-sm"><i class="fa fa-lock"></i> &nbsp;Ganti Password</a>
    ...
    <div class="col-sm-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="frm_upload" name="frm_upload" action="{{ url('my-account/upload-file/'.$updateID) }}" method="POST" class="form-horizontal" enctype="multipart/form-data"> 
                @csrf
...
<div class="modal fade" id="delete-picture-modal" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
      <form id="frm_delete" name="frm_delete" action="{{ url('my-account/remove-file/'.$updateID) }}" method="POST">
      @csrf
      <div class="modal-content">
        <div class="modal-header">
